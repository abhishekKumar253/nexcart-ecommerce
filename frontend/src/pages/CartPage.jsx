...
function CartPage() {
  ...
  if (items.length === 0) {
    ...
    cartContent = <CartSkeleton lines={items.length} />;
    ...
    cartContent = (
      <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="card border border-base-300 bg-base-100 p-6 shadow-md">
          ...
          <SignedIn>
            {/* 👇 Error banner dikhaya */}
            {checkoutError && (
              <div className="alert alert-error alert-sm mt-4 text-sm">
          ...
          <p className="mt-4 flex items-start gap-2 text-xs text-base-content/60">
            ...
            <span>
              ...
              <strong className="text-base-content">support chat</strong>. Video
